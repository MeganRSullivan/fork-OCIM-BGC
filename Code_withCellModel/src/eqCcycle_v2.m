...
%        keyboard
    ...
    elseif (par.optim & nargout > 3);
        ...
        elseif par.TPmodel ==on;
            ...
            C2P_cc_dd   = (2*Tz)./p2c.^3;
            C2P_ccP_ccP = (2*PO4z.^2)./p2c.^3;
            C2P_ccP_dd  = (2*PO4z)./p2c.^3;
            C2P_dd_dd   = 2./p2c.^3;
		else
        	p2c       = cc*PO4 + dd;
        	C2P_dd_dd = 2./p2c.^3;
        ...
        if (par.opt_sigP & par.opt_cc)
            kk  = kk + 1;
            C2P_dxtmp = cc*C2P_cc; %dC2P/dlog(cc)
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lsigP))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*Gx(:,pindx.lsigP))*C2P_dxtmp; ... 
                      d0(sigC*Gx(:,pindx.lsigP))*C2P_dxtmp; ... 
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lsigP))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.lsigP))*C2P_dxtmp ; ...
                      -d0(Gx(:,pindx.lsigP))*C2P_dxtmp; ...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_sigP & par.opt_ccT)
            kk  = kk + 1;
        ...
        if (par.opt_sigP & par.opt_ccP)
            kk  = kk + 1;
            C2P_dxtmp = ccP*C2P_ccP; %dC2P/dlog(cc)
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lsigP))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*Gx(:,pindx.lsigP))*C2P_dxtmp; ... 
                      d0(sigC*Gx(:,pindx.lsigP))*C2P_dxtmp; ... 
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lsigP))*C2P_dxtmp; ...
        ...
        if (par.opt_Q10P & par.opt_cc)
            kk = kk + 1;
            C2P_dxtmp = cc*C2P_cc ; %dC2P/dlog(cc)
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lQ10P))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.lQ10P))*C2P_dxtmp; ...
                      sigC*d0(Gx(:,pindx.lQ10P))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lQ10P))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.lQ10P))*C2P_dxtmp; ...
                      -d0(Gx(:,pindx.lQ10P))*C2P_dxtmp; ...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_Q10P & par.opt_ccT)
            kk = kk + 1;
        ...
        if (par.opt_kdP & par.opt_cc)
            kk  = kk + 1;
            C2P_dxtmp = cc*C2P_cc;
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      sigC*d0(Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      -d0(Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_kdP & par.opt_ccT)
            kk  = kk + 1;
        ...
        if (par.opt_kdP & par.opt_ccP)
            kk  = kk + 1;
            C2P_dxtmp = ccP*C2P_ccP;
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      sigC*d0(Gx(:,pindx.lkdP))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lkdP))*C2P_dxtmp; ...
        ...
        if (par.opt_bP_T & par.opt_cc)
            kk = kk + 1;
            C2P_dxtmp = cc*C2P_cc; 
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.bP_T))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.bP_T))*C2P_dxtmp; ...
                      sigC*d0(Gx(:,pindx.bP_T))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.bP_T))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.bP_T))*C2P_dxtmp; ...
                      -d0(Gx(:,pindx.bP_T))*C2P_dxtmp; ...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_bP_T & par.opt_ccT)
            kk = kk + 1;
        ...
        if (par.opt_bP & par.opt_cc)
            kk = kk + 1;
            C2P_dxtmp = cc*C2P_cc ;
            tmp = [-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lbP))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.lbP))*C2P_dxtmp;...
                      sigC*d0(Gx(:,pindx.lbP))*C2P_dxtmp;...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lbP))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.lbP))*C2P_dxtmp ; ...
                      -d0(Gx(:,pindx.lbP))*C2P_dxtmp;...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_bP & par.opt_ccT)
            kk = kk + 1;
        ...
        if (par.opt_alpha & par.opt_cc)
            kk  = kk + 1;
            C2P_dxtmp = cc * C2P_cc ;
            tmp = cc*[-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lalpha))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.lalpha))*C2P_dxtmp; ...
                      sigC*d0(Gx(:,pindx.lalpha))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lalpha))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.lalpha))*C2P_dxtmp; ...
                      -d0(Gx(:,pindx.lalpha))*C2P_dxtmp; ...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_alpha & par.opt_ccT)
            kk  = kk + 1;
        ...
        if (par.opt_beta & par.opt_cc)
            kk = kk + 1;
            C2P_dxtmp = cc * C2P_cc ;
            tmp = cc*[-d0(((1-sigC-gamma)*RR)*Gx(:,pindx.lbeta))*C2P_dxtmp; ...
                      (1-sigC-gamma)*d0(Gx(:,pindx.lbeta))*C2P_dxtmp; ...
                      sigC*d0(Gx(:,pindx.lbeta))*C2P_dxtmp; ...
                      d0((1-sigC-gamma)*RR*Gx(:,pindx.lbeta))*C2P_dxtmp; ...
                      d0(-2*(1-sigC-gamma)*RR*Gx(:,pindx.lbeta))*C2P_dxtmp ; ...
                      -d0(Gx(:,pindx.lbeta))*C2P_dxtmp; ...
                      Z];
            
            RHS(:,kk) = tmp;
        end
        if (par.opt_beta & par.opt_ccT)
            kk = kk + 1;
        ...
        if (par.opt_sigC & par.opt_ccT == on)
            kk = kk + 1;
        ...
        if (par.opt_sigC & par.opt_ccP == on)
            kk = kk + 1;
            C2P_dxtmp = ccP * C2P_ccP ;
            tmp = cc*[sigC*RR*(G*C2P_dxtmp); ...
                      -sigC*G*C2P_dxtmp; ...
        ...
        if (par.opt_kru & par.opt_ccP)
            kk = kk + 1;
            tmp = [kru*UM*DOCrx(:,pindx.lccP) ; ...
                   Z ; ...
                   Z ; ...
                   Z ; ...
                   -kru*N2C*UM*DOCrx(:,pindx.lccP); ...
                   Z ; ...
                   -kru*UM*DOCrx(:,pindx.lccP)] ;
        ...
        if (par.opt_krd & par.opt_ccP)
            kk = kk + 1;
            tmp = [krd*DM*DOCrx(:,pindx.lccP) ; ...
                   Z ; ...
                   Z ; ...
                   Z ; ...
                   -krd*N2C*DM*DOCrx(:,pindx.lccP); ...
                   Z ; ...
                   -krd*DM*DOCrx(:,pindx.lccP)] ;
        ...
        if (par.opt_etau & par.opt_ccP)
            kk = kk + 1;
            tmp = [etau*WM*kC*DOCx(:,pindx.lccP) ; ...
                   Z ; ...
                   Z ; ...
                   Z ; ...
                   -etau*WM*N2C*kC*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   -etau*WM*kC*DOCx(:,pindx.lccP)] ;
        ...
        if (par.opt_etad & par.opt_ccP)
            kk = kk + 1;
            tmp = [etad*DM*kC*DOCx(:,pindx.lccP) ; ...
                   Z ; ...
                   Z ; ...
                   Z ; ...
                   -etad*DM*N2C*kC*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   -etad*DM*kC*DOCx(:,pindx.lccP)] ;
        ...
        if (par.opt_bC_T & par.opt_ccP)
            kk = kk + 1;
            tmp = [Z ; ...
                   -PFD_bm*POCx(:,pindx.lccP); ...
                   Z ; ...
                   Z ; ...
                   Z ; ...
                   Z ; ...
        ...
        if (par.opt_bC & par.opt_ccP)
            kk = kk + 1;
            tmp = bC*[Z ; ...
                      -PFD_bb*POCx(:,pindx.lccP); ...
                      Z ; ...
                      Z ; ...
                      Z ; ...
                      Z ; ...
        ...
        if (par.opt_d & par.opt_ccP)
            kk = kk + 1;
            tmp = [Z ; ...
                   Z ; ...
                   Z ; ...
                   -d*PFD_d*PICx(:,pindx.lccP); ...
                   Z ; ...
                   Z ; ...
                   Z];
        ...
        if (par.opt_Q10C & par.opt_ccP)
            kk = kk + 1;
            tmp = [eta*d0(kC_Q10C)*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   -d0(kC_Q10C)*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   -eta*N2C*d0(kC_Q10C)*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   (I-eta)*d0(kC_Q10C)*DOCx(:,pindx.lccP)] ;
        ...
        if (par.opt_kdC & par.opt_ccP)
            kk = kk + 1;
            tmp = [eta*kC_kdC*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   -kC_kdC*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   -eta*N2C*kC_kdC*DOCx(:,pindx.lccP); ...
                   Z ; ...
                   (I-eta)*kC_kdC*DOCx(:,pindx.lccP)] ;
        ...
        if (par.opt_cc)
            kk = kk + 1;
            C2P_dxtmp = cc * (C2P_cc + cc*C2P_cc_cc);
            tmp = [-((1-sigC-gamma)*RR)*(G*(C2P_dxtmp)); ...
                      (1-sigC-gamma)*G*(C2P_dxtmp); ...
                      sigC*G*(C2P_dxtmp); ...
                      (1-sigC-gamma)*RR*(G*(C2P_dxtmp)); ...
        ...
        if (par.opt_cc & par.opt_dd)
            kk = kk + 1;
            C2P_dxtmp = cc*dd*C2P_cc_dd ;
            tmp = cc*dd*[-((1-sigC-gamma)*RR)*(G*C2P_dxtmp); ...
                         (1-sigC-gamma)*G*C2P_dxtmp; ...
                         sigC*G*C2P_dxtmp; ...
                         (1-sigC-gamma)*RR*(G*C2P_dxtmp); ...
                         -2*(1-sigC-gamma)*RR*(G*C2P_dxtmp) ; ...
        ...
        % ccT ccP
        if (par.opt_ccT & par.opt_ccP)
            kk = kk + 1;
            C2P_dxtmp = ccP * (C2P_cc_ccP) ;
            tmp = [-((1-sigC-gamma)*RR)*(G*C2P_dxtmp); ...
                         (1-sigC-gamma)*G*C2P_dxtmp; ...
                         sigC*G*C2P_dxtmp; ...
                         (1-sigC-gamma)*RR*(G*C2P_dxtmp); ...
        ...
        if (par.opt_ccP)
            kk = kk + 1;
            C2P_dxtmp = ccP * (C2P_ccP + ccP*C2P_ccP_ccP);
            tmp = [-((1-sigC-gamma)*RR)*(G*(C2P_dxtmp)); ...
                      (1-sigC-gamma)*G*(C2P_dxtmp); ...
                      sigC*G*(C2P_dxtmp); ...
                      (1-sigC-gamma)*RR*(G*(C2P_dxtmp)); ...
        ...
        % ccP ddT
        if (par.opt_ccP & par.opt_ddT)
            kk = kk + 1;
            C2P_dxtmp = ccP*ddT*C2P_ccP_dd ;
            tmp = cc*dd*[-((1-sigC-gamma)*RR)*(G*C2P_dxtmp); ...
                         (1-sigC-gamma)*G*C2P_dxtmp; ...
                         sigC*G*C2P_dxtmp; ...
                         (1-sigC-gamma)*RR*(G*C2P_dxtmp); ...
